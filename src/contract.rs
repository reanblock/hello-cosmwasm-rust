...
use cosmwasm_std::{
    to_json_binary, coins, BankMsg, Binary, Deps, Event, DepsMut, Env, MessageInfo, Response, StdResult,
};
    ...
    fn instantiation() {
        ...
        let addr = app
            .instantiate_contract(
                ...
                &InstantiateMsg { admins: vec![], donation_denom: "".to_string()},
                &[],
                "Contract",
                None,
            )
